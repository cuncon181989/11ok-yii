<div id="webLeftmain">
	<div id="webDiary">
		<div id="webLt" class="lt-title"><strong class="FloatLeft">　所有留言</strong><span class="FloatRight diarypage">
			<?php if(Yii::app()->user->getState('isOwner')){echo CHtml::link('留言管理', array('GuestBook/admin','username'=>$this->_user->username));} ?></span>
				<div class="clr"></div>
		</div>
			<div id="webmessage">
			<ul>
