<div id="webLeftmain">
	<div id="webLt"  class="lt-title">
			...
			<?php if(Yii::app()->user->getState('isOwner')){echo CHtml::linkButton('删除照片',array('submit'=>array('gallery/delete','id'=>$gallery->id,'username'=>Yii::app()->user->name),'confirm'=>'确定删除?'));} ?>
			</span>
	</div>
