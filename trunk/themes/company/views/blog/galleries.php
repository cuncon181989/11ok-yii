<div id="webLeftmain">
	<div id="webLt"  class="lt-title">
			...
			<span class="FloatRight"><?php if(Yii::app()->user->getState('isOwner')){echo CHtml::link('上传相片',array('gallery/upload','username'=>Yii::app()->user->name));} ?>
	...
	<div id="webxiangce">
	  ...
	  <div class="clr"></div>
	<?php $this->widget('CLinkPager',array('pages'=>$pages,'header'=>'')); ?></div>
</div>
