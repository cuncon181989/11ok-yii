...
document.write("<div class=\"guide\" id=\"guide\" style=\"margin-top:"+(height-23)+"px;margin-left:"+(width-75)+"px\">");
...
for(var i=0;i<blockCount;i++){
	...
	for(var j=0;j<pictureCount;j++){
		document.write("<a href=\""+href[i]+"\" target=\"_blank\" style=\"background:url(js/ad.jpg) 0 "+(j+now)*height+"px;height:"+height+"px\"></a>");
	}
	document.write("</div>");
