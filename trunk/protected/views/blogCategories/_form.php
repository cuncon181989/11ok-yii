...
<div class="simple"><?php echo CHtml::activeLabelEx($model,'name'); ?> <?php echo CHtml::activeTextField($model,'name',array('size'=>50,'maxlength'=>50)); ?>
</div>
...
<div class="simple"><?php echo CHtml::activeLabelEx($model,'countBlogs'); ?>
<?php echo CHtml::activeTextField($model,'countBlogs'); ?></div>
